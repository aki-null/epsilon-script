...
Unique integers generated by `GetUniqueIdentifier` extension method are used to address variable names for performance reasons.
...
var variables = new Dictionary<uint, VariableValue> {[valIdentifier] = new VariableValue(43.0f)};
...
var compiler = new Compiler();
var valIdentifier = "val".GetUniqueIdentifier();
var variables = new Dictionary<string, VariableValue> {[valIdentifier] = new VariableValue(43.0f)};
