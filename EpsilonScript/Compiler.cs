...
namespace EpsilonScript
{
  public class Compiler
  {
    ...
    public Compiler()
    {
      ...
      AddCustomFunction(new CustomFunction("ifelse", (bool cond, int v1, int v2) => cond ? v1 : v2, true));
      AddCustomFunction(new CustomFunction("ifelse", (bool cond, float v1, float v2) => cond ? v1 : v2, true));
      AddCustomFunction(new CustomFunction("ifelse", (bool cond, string v1, string v2) => cond ? v1 : v2, true));
