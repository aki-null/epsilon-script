...
namespace EpsilonScript.Tests.AST
{
  public class AST_BoundaryValues : AstTestBase
  {
    ...
    [InlineData("1")]
    [InlineData("-1")]
    internal void AST_Integer_BoundaryValues_Succeeds(string value)
    {
    ...
    internal void AST_Integer_OverflowValues_ThrowsOverflowException(string value)
    {
      var node = new IntegerNode();
      var rpn = CreateStack();
      var element = new Element(new Token(value, TokenType.Integer), ElementType.Integer);
    ...
    [InlineData("1.0")]
    [InlineData("-1.0")]
    internal void AST_Float_BoundaryValues_Succeeds(string value)
    {
    ...
    [Fact]
    internal void AST_Comparison_IntegerBoundaryValues_Succeeds()
    {
    ...
    [Fact]
    internal void AST_Comparison_FloatBoundaryValues_Succeeds()
    {
    ...
    internal void AST_String_VariousLengths_Succeeds(string value)
    {
