...
namespace EpsilonScript.Tests.AST
{
  ...
  [Trait("Component", "AST")]
  public class AstVariableAutoConversionTests
  {
    [Fact]
    internal void Variable_AutoConverts_FloatVariableToDouble_WhenCompilerUsesDouble()
    {
    ...
    [Fact]
    internal void Variable_AutoConverts_DoubleVariableToFloat_WhenCompilerUsesFloat()
    {
    ...
    [Fact]
    internal void Variable_AutoConverts_DecimalVariableToDouble_WhenCompilerUsesDouble()
    {
      // Compiler configured for Double precision
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    internal void Variable_AutoConverts_IntegerVariableToLong_WhenCompilerUsesLong()
    {
    ...
    [Fact]
    internal void Variable_AutoConverts_LongVariableToInteger_WhenCompilerUsesInteger()
    {
    ...
    [Fact]
    internal void Variable_AutoConverts_MixedPrecisionVariables_InComplexExpression()
    {
    ...
    [Fact]
    internal void Variable_AutoConverts_FloatToDouble_InComparison()
    {
      // Compiler configured for Double precision
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    internal void Variable_AutoConverts_ComparesMixedPrecisionVariables()
    {
      // Compiler configured for Double precision
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    internal void Variable_AutoConverts_WithAssignmentOperations()
    {
      // Compiler configured for Double precision
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    internal void Variable_AutoConverts_DoesNotAffectBooleanVariables()
    {
    ...
    [Fact]
    internal void Variable_AutoConverts_DoesNotAffectStringVariables()
    {
      // Compiler configured with any precision
    ...
    [Fact]
    internal void Variable_AutoConverts_PreservesOriginalVariableType()
    {
      // Compiler configured for Double precision
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    internal void Variable_AutoConverts_DecimalToDouble_InArithmeticChain()
    {
      // Compiler configured for Double precision
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
