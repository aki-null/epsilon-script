...
{
  public class AstSequenceTests : AstTestBase
  {
    [Theory]
    [InlineData(5, 10, ExtendedType.Integer)]
    [InlineData(-3, 42, ExtendedType.Integer)]
    internal void Sequence_WithTwoIntegers_ReturnsRightValue(int leftValue, int rightValue, ValueType expectedType)
    {
    ...
    internal void Sequence_WithTwoFloats_ReturnsRightValue(float leftValue, float rightValue,
    ...
    internal void Sequence_WithTwoBooleans_ReturnsRightValue(bool leftValue, bool rightValue,
      ValueType expectedType)
    {
      var node = new SequenceNode();
    ...
    [Fact]
    internal void Sequence_WithMixedTypes_ReturnsRightType()
    {
      var node = new SequenceNode();
    ...
    [Fact]
    internal void Sequence_ExecutesBothNodes()
    {
    ...
    [Fact]
    internal void Sequence_WithSingleNode_ActsAsNoOp()
    {
      var node = new SequenceNode();
    ...
    [Fact]
    internal void Sequence_IsPrecomputable_WithTwoConstantNodes_ReturnsTrue()
    {
      var node = new SequenceNode();
    ...
    [Fact]
    internal void Sequence_IsPrecomputable_WithOneVariableNode_ReturnsFalse()
    {
      var node = new SequenceNode();
    ...
    [Fact]
    internal void Sequence_Optimize_WithConstantNodes_ReturnsValueNode()
    {
      var node = new SequenceNode();
    ...
    [Fact]
    internal void Sequence_Optimize_WithNonConstantNodes_ReturnsSelf()
    {
      var node = new SequenceNode();
    ...
    internal void Sequence_WorksWithAllCompilerOptions(Compiler.Options options)
    {
      var node = new SequenceNode();
    ...
    [Fact]
    internal void Sequence_WithTupleValues_PropagatesTupleFromRightNode()
    {
    ...
    [Fact]
    internal void Sequence_WithMultipleSemicolons_ReturnsRightmostValue()
    {
    ...
    [Fact]
    internal void Sequence_WithMultipleSemicolons_ExecutesAllNodes()
    {
    ...
    [Fact]
    internal void Sequence_WithConsecutiveSemicolons_HandlesEmptyStatements()
    {
