...
namespace EpsilonScript.Tests
{
  ...
  public class CompiledScript_Precision
  {
    #region Integer Precision Tests

    [Fact]
    public void CompiledScript_WithIntegerPrecision_CompilesIntegerValues()
    {
    ...
    [Fact]
    public void CompiledScript_WithLongPrecision_CompilesLongValues()
    {
    ...
    [Fact]
    public void CompiledScript_WithIntegerPrecision_ThrowsOnLongLiteral()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Float);
    ...
    public void CompiledScript_WithLongPrecision_AcceptsLargeIntegerLiterals(string literal, long expectedValue)
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Long, Compiler.FloatPrecision.Float);
    ...
    [Fact]
    public void CompiledScript_WithLongPrecision_IntegerArithmeticProducesLong()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Long, Compiler.FloatPrecision.Float);
    ...
    [Fact]
    public void CompiledScript_WithFloatPrecision_CompilesFloatValues()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Float);
    ...
    [Fact]
    public void CompiledScript_WithDoublePrecision_CompilesDoubleValues()
    {
    ...
    [Fact]
    public void CompiledScript_WithDecimalPrecision_CompilesDecimalValues()
    {
    ...
    [Fact]
    public void CompiledScript_WithDoublePrecision_FloatArithmeticProducesDouble()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    public void CompiledScript_WithDecimalPrecision_FloatArithmeticProducesDecimal()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Decimal);
    ...
    public void CompiledScript_WithAllPrecisionCombinations_StoresPrecisionSettings(
    ...
    [Fact]
    public void CompiledScript_IntAndFloatMixed_UsesConfiguredFloatPrecision()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    public void CompiledScript_LongAndDouble_UsesDouble()
    {
    ...
    [Fact]
    public void CompiledScript_IntegerValue_ReturnsInt32()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Float);
      var script = compiler.Compile("42");
      script.Execute();
    ...
    [Fact]
    public void CompiledScript_LongValue_ReturnsInt64()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Long, Compiler.FloatPrecision.Float);
    ...
    [Fact]
    public void CompiledScript_FloatValue_ReturnsFloat()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Float);
      var script = compiler.Compile("3.14");
      script.Execute();
    ...
    [Fact]
    public void CompiledScript_DoubleValue_ReturnsDouble()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
      var script = compiler.Compile("3.141592653589793");
      script.Execute();
    ...
    [Fact]
    public void CompiledScript_DecimalValue_ReturnsDecimal()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Decimal);
      var script = compiler.Compile("3.141592653589793238");
      script.Execute();
    ...
    [Fact]
    public void CompiledScript_WithLongPrecision_ComplexExpression()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Long, Compiler.FloatPrecision.Float);
    ...
    [Fact]
    public void CompiledScript_WithDoublePrecision_ComplexExpression()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    public void CompiledScript_WithDecimalPrecision_HighPrecisionCalculation()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Decimal);
    ...
    [Fact]
    public void CompiledScript_WithLongAndDecimal_ComplexExpression()
    {
    ...
    [Fact]
    public void CompiledScript_WithLongPrecision_ComparisonReturnsBoolean()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Long, Compiler.FloatPrecision.Float);
    ...
    [Fact]
    public void CompiledScript_WithDoublePrecision_ComparisonReturnsBoolean()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Double);
    ...
    [Fact]
    public void CompiledScript_WithDecimalPrecision_ExactComparison()
    {
      var compiler = new Compiler(Compiler.IntegerPrecision.Integer, Compiler.FloatPrecision.Decimal);
